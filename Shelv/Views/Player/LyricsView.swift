...
struct LyricsView: View {
    ...
    private func content(for record: LyricsRecord) -> some View {
        if record.isInstrumental {
            placeholder(icon: "pianokeys", text: tr("Instrumental", "Instrumental", "纯音乐"))
            ...
            placeholder(icon: "text.page.slash", text: tr("No lyrics available", "Keine Lyrics verfügbar", "暂无歌词"))
        }
    }
